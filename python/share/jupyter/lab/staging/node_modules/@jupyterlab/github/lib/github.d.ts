 ...
 */
export declare function browserApiRequest<T>(url: string): Promise<T>;
/**
 ...
 * @returns a Promise resolved with the JSON response.
 */
export declare function proxiedApiRequest<T>(url: string, settings: ServerConnection.ISettings): Promise<T>;
/**
 ...
 */
export declare type GitHubDirectoryListing = GitHubContents[];
/**
