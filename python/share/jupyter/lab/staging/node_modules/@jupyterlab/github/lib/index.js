...
function activateFileBrowser(app, manager, factory, restorer, settingRegistry) {
    ...
    const onSettingsUpdated = async (settings) => {
        ...
        const accessToken = settings.get('accessToken').composite;
    ...
    Promise.all([settingRegistry.load(PLUGIN_ID), app.restored])
        ...
        shouldWarn = true;
        const defaultRepo = settings.get('defaultRepo').composite;
        if (defaultRepo) {
...
(function (Private) {
    ...
    async function showWarning() {
        return showDialog({
            ...
            body: 'Adding a client side access token can pose a security risk! ' +
