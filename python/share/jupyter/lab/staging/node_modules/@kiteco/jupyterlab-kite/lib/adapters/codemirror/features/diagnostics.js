...
import { DIAGNOSTICS_LISTING_CLASS, DiagnosticsDatabase, DiagnosticsListing } from './diagnostics_listing';
// TODO: settings
            ...
            try {
                ...
                diagnostics_by_range.forEach((diagnostics, range) => {
                    ...
                    if (start.line > this.virtual_document.last_virtual_line) {
                        console.log('Malformed diagnostic was skipped (out of lines) ', diagnostics);
                        return;
                    }
                    let document;
                    try {
