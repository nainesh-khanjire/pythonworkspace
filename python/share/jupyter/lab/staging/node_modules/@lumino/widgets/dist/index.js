    ...
    (function (CommandPalette) {
        ...
        var Renderer = /** @class */ (function () {
            ...
            Renderer.prototype.formatItemShortcut = function (data) {
                ...
                return kb
                    ? kb.keys.map(commands.CommandRegistry.formatKeystroke).join(', ')
                    : null;
            };
            /**
    ...
    (function (MenuBar) {
        ...
        var Renderer = /** @class */ (function () {
            ...
            Renderer.prototype.renderItem = function (data) {
                ...
                var dataset = this.createItemDataset(data);
                var aria = this.createItemARIA(data);
                return virtualdom.h.li(__assign({ className: className, dataset: dataset, tabindex: '0', onfocus: data.onfocus }, aria), this.renderIcon(data), this.renderLabel(data));
            };
            /**
