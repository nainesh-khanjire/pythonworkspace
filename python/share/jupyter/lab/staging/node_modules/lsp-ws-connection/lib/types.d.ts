...
export declare type AnyLocation = lsProtocol.Location | lsProtocol.Location[] | lsProtocol.LocationLink[] | null;
export declare type AnyCompletion = lsProtocol.CompletionList | lsProtocol.CompletionItem[];
declare type ConnectionEvent = 'completion' | 'completionResolved' | 'hover' | 'diagnostic' | 'highlight' | 'signature' | 'goTo' | 'error' | 'logging';
export interface ILspConnection {
    ...
    on(event: 'hover', callback: (hover: lsProtocol.Hover, documentUri: string) => void): void;
    on(event: 'diagnostic', callback: (diagnostic: lsProtocol.PublishDiagnosticsParams) => void): void;
    on(event: 'highlight', callback: (highlights: lsProtocol.DocumentHighlight[], documentUri: string) => void): void;
    on(event: 'signature', callback: (signatures: lsProtocol.SignatureHelp) => void): void;
    on(event: 'goTo', callback: (location: AnyLocation, documentUri: string) => void): void;
     ...
     */
    getCompletion(location: IPosition, token: ITokenInfo, documentInfo: IDocumentInfo, emit?: boolean, triggerCharacter?: string, triggerKind?: lsProtocol.CompletionTriggerKind): void;
    /**
 ...
 */
export declare abstract class IEditorAdapter<T> {
...
export declare function getFilledDefaults(options: ITextEditorOptions): ITextEditorOptions;
export {};
